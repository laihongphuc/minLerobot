...
Run from the repo root with:
    conda run -n lerobot pytest test.py -v
"""
...
from compute_norm_stats import load_norm_stats, save_norm_stats
from dataset import MyLeRobotDataset, collate_fn

DATA_PATH = os.environ.get("MINLEROBOT_DATA_PATH", "/home/phuclh12/data/so101_pick/")
FPS = 30
ACTION_DIM = 6
...
def test_query_indices(delta_dataset):
    ...
    current_episode = delta_dataset.episode_index[abs_idx]
